 ...
 * {@link NearbySearchFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link NearbySearchFragment#newInstance} factory method to
...
public class NearbySearchFragment extends Fragment {
     ...
     * @return A new instance of fragment NearbySearchFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static NearbySearchFragment newInstance(String param1, String param2) {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        listView.setAdapter(new NearBySearchAdapter(getActivity()));
    ...
    public void onButtonPressed(Uri uri) {
        if (mListener != null) {
            mListener.onNearBySearchFragmentInteraction(uri);
        }
    }
